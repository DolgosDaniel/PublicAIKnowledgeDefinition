...
`roadmap`, alongside the usual engineering pointers on `component.md`.

Stakeholders and decision-makers stay on the Product Brief page in Confluence — PAIK never
reintroduces a `participants.md`; see `project.md`'s "Who's involved" section.

Start at [`paik/project.md`](paik/project.md). See [`../simple-project/`](../simple-project/) for
the same single-service shape read from an engineering angle instead.
